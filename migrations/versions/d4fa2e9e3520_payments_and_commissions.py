...
Revision ID: d4fa2e9e3520
Revises: 9c111eecaeea
Create Date: 2023-09-21 14:42:11.972966
...
def upgrade():
    ...
    commissionstatus = sa.dialects.postgresql.ENUM(
        "REQUESTED",
        "SENT",
        "CONFIRM",
        "UNPAID",
    ...
    paymentstatus = sa.dialects.postgresql.ENUM(
        "REQUESTED",
        "SENT",
        "CONFIRM",
        "UNPAID",
