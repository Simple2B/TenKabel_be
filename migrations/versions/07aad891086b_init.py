...
def upgrade():
    ...
    sa.Column('status', sa.Enum('PENDING', 'APPROVED', 'IN_PROGRESS', 'JOB_IS_FINISHED', name='jobstatus'), nullable=False),
    ...
    sa.Column('commission_status', sa.Enum('PAID', 'UNPAID', 'REQUESTED', name='commissionstatus'), nullable=False),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('uuid', sa.String(length=36), nullable=False),
    sa.Column('type', sa.Enum('JOB_CREATED', 'JOB_STARTED', 'JOB_DONE', 'JOB_CANCELED', 'JOB_PAID', 'COMMISSION_REQUESTED', 'COMMISSION_PAID', 'MAX_JOB_TYPE', 'APPLICATION_CREATED', 'APPLICATION_ACCEPTED', 'APPLICATION_REJECTED', 'MAX_APPLICATION_TYPE', name='notificationtype'), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    ...
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('status', sa.Enum('PAID', 'UNPAID', 'REJECTED', 'PROGRESS', name='platformpaymentstatus'), nullable=False),
    sa.Column('reject_reason', sa.String(length=512), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('paid_at', sa.DateTime(), nullable=True),
    sa.Column('rejected_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_platform_payments_user_id_users')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_platform_payments'))
    )
    op.create_table('users_locations',
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('location_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['location_id'], ['locations.id'], name=op.f('fk_users_locations_location_id_locations')),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_users_locations_user_id_users')),
    sa.PrimaryKeyConstraint('user_id', 'location_id', name=op.f('pk_users_locations'))
    )
    op.create_table('users_notifications_locations',
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('location_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['location_id'], ['locations.id'], name=op.f('fk_users_notifications_locations_location_id_locations')),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_users_notifications_locations_user_id_users')),
    sa.PrimaryKeyConstraint('user_id', 'location_id', name=op.f('pk_users_notifications_locations'))
    )
    op.create_table('users_notifications_professions',
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('profession_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['profession_id'], ['professions.id'], name=op.f('fk_users_notifications_professions_profession_id_professions')),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_users_notifications_professions_user_id_users')),
    sa.PrimaryKeyConstraint('user_id', 'profession_id', name=op.f('pk_users_notifications_professions'))
    )
    op.create_table('users_professions',
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('profession_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['profession_id'], ['professions.id'], name=op.f('fk_users_professions_profession_id_professions')),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_users_professions_user_id_users')),
    sa.PrimaryKeyConstraint('user_id', 'profession_id', name=op.f('pk_users_professions'))
    )
    ...
    sa.Column('owner_id', sa.Integer(), nullable=False),
    sa.Column('worker_id', sa.Integer(), nullable=True),
    sa.Column('status', sa.Enum('PENDING', 'ACCEPTED', 'DECLINED', name='applicationstatus'), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['owner_id'], ['users.id'], name=op.f('fk_applications_owner_id_users')),
    ...
    sa.ForeignKeyConstraint(['job_id'], ['jobs.id'], name=op.f('fk_platform_commissions_job_id_jobs')),
    sa.ForeignKeyConstraint(['platform_payment_id'], ['platform_payments.id'], name=op.f('fk_platform_commissions_platform_payment_id_platform_payments')),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_platform_commissions_user_id_users')),
    ...
    sa.Column('job_id', sa.Integer(), nullable=False),
    sa.Column('rate', sa.Enum('POSITIVE', 'NEGATIVE', 'NEUTRAL', name='ratestatus'), nullable=False),
    sa.ForeignKeyConstraint(['job_id'], ['jobs.id'], name=op.f('fk_rate_job_id_jobs')),
    sa.ForeignKeyConstraint(['owner_id'], ['users.id'], name=op.f('fk_rate_owner_id_users')),
    sa.ForeignKeyConstraint(['worker_id'], ['users.id'], name=op.f('fk_rate_worker_id_users')),
